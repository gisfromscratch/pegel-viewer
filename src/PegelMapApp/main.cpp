...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterType<MapQuickView>("Esri.PegelMapApp", 1, 0, "MapView");

    // Register the PegelMapApp (QQuickItem) for QML
    qmlRegisterType<PegelMapApp>("Esri.PegelMapApp", 1, 0, "PegelMapApp");
